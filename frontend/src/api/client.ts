...
export type ReferenceDatasetInfo = Schemas["ReferenceDatasetInfo"];
...
export type BoxShape = Schemas["BoxShape-Output"];
export type BitmapShape = Schemas["BitmapShape-Output"];
export type AnnotationShape = PolygonShape | BoxShape | BitmapShape;
...
export type DetectionComparison = Schemas["DetectionComparison"];
export type DetectionRun = Schemas["DetectionRun"];
...
export type DetectionOutcomes = Schemas["DetectionOutcomes"];
export type DetectionVerdict = Schemas["DetectionVerdict"];
export type ImageBoxes = Schemas["ImageBoxes"];
export type PredictedBox = Schemas["PredictedBox"];
export type TrueBox = Schemas["TrueBox"];
