-- Registering all locally present public reference datasets is one long-running job.
-- SQLite cannot alter the kind CHECK, so rebuild the unreferenced job table as in 002.
