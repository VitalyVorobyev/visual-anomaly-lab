...
| `glass_anomalib` | Experimental GLASS ([arXiv:2407.09359](https://arxiv.org/abs/2407.09359)) via anomalib. Perlin regions and mined feature perturbations teach a discriminator to separate normal from synthetic anomalies; the bounded public gate missed its image-level promotion floor. | `--extra dl` |
